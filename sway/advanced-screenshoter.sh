#!/bin/bash
# используй это как заготовку
# в будущем я хочу получить от скриншотера следующее:
# скриншот всей области
# скриншот выбранной области
# выбор, который вылетает и спрашивает нас, сохранять ли файл на компьютере или же просто
# скопировать в буфер обмена
#
# так же можно добавить задание имени
#
# requirements: bash, dmenu
